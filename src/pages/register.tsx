...
export default function Register() {
  ...
  const validate = () => {
    ...
    else if (!/^[a-zA-Z0-9_]{3,20}$/.test(form.nickname)) e.nickname = "3–20 chars, letters/numbers/_";
      ...
      <div className="form-area">
        {form.success ? (
          ...
          <div className="form-inner">
            ...
            <div className="fields">
              ...
              <div className={cls("password")}>
                ...
                <div className="input-wrap">
                  <input id="password" type={showPw ? "text" : "password"} autoComplete="new-password" placeholder="••••••••" {...fp("password")} />
              ...
              <div className={cls("confirm")}>
                ...
                <div className="input-wrap">
                  <input id="confirm" type={showCf ? "text" : "password"} autoComplete="new-password" placeholder="••••••••" {...fp("confirm")} />
                  <button type="button" className="toggle-pw" onClick={() => setShowCf(s => !s)} aria-label="Toggle confirm">
                    {showCf ? "hide" : "show"}
                  </button>
                </div>
            ...
            <button className="submit" style={{marginTop:"16px"}} onClick={handleSubmit} disabled={form.loading}>
